...
$lang['about_app'] = 'Au sujet d\'Tooth Software';
...
$lang['about_app_info'] = 'Tooth Software est une application Web hautement personnalisable qui permet à vos clients de prendre rendez-vous avec vous via le web. En outre, elle offre la possibilité de synchroniser vos données avec un calendrier Google afin que vous puissiez les utiliser avec d\'autres services. Tooth Software est un projet open source et vous pouvez le télécharger et l\'installer même pour un usage commercial. Tooth Software fonctionnera sans problème avec votre site web existant car il peut être installé dans un dossier spécifique du serveur et bien sûr, les deux sites peuvent partager la même base de données.';
...
$lang['about_app_license'] = 'Tooth Software est enregistré sous licence GPLv3. En utilisant le code d\'Tooth Software, quelqu\'en soit l\'usage, vous êtes tenu d\'accepter les termes décrits dans l\'URL suivante:';
...
$lang['ea_update_success'] = 'Tooth Software à été mis à jour avec succès .';
