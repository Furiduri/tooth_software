...
$lang['about_app'] = 'Tooth Software Hakkında';
...
$lang['about_app_info'] = 'Tooth Software yüksek ölçüde özelleştirilebilen, müşterilerinizin web üzerinden randevu almasını sağlayan bir uygulamadır. Ayrıca, bilgilerinizi Google Takvim ile eşitleyerek diğer uygulamalarla da entegre olmasını sağlar. ';
$lang['current_version'] = 'Mevcut Versiyon';
$lang['support'] = 'Destek';
$lang['about_app_support'] = 'Tooth Software kullanımı sırasında sorun yaşamanız halinde resmi Google Group üzerinde arama yapabilirsiniz. Ayrıca geliştirmeye destek olmak için Google Code sayfasında yeni sorun girişi de yapabilirsiniz.';
...
$lang['license'] = 'Lisans';
$lang['about_app_license'] = 'Tooth Software GPLv3 kapsamında lisanslıdır. Bu yazılımı herhangi bir biçimde kullanarak aşağıdaki adreste belirtilen koşulları kabul etmiş olursunuz:';
...
$lang['ea_update_success'] = 'Tooth Software başarı ile güncellendi.';
