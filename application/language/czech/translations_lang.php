...
$lang['about_app'] = 'O aplikaci Tooth Software';
...
$lang['about_app_info'] = 'Tooth Software je vysoce přizpůsobitelná webová aplikace, která vašim zákazníkům umožňuje rezervovat si s vámi schůzky prostřednictvím webu. Navíc poskytuje možnost synchronizovat vaše data s Kalendářem Google, takže je můžete využívat v rámci dalších služeb.';
$lang['current_version'] = 'Aktuální verze';
$lang['support'] = 'Podpora';
$lang['about_app_support'] = 'Pokud při používání Tooth Software narazíte na jakékoli problémy můžete odpovědi hledat v oficiální skupině Google. Také můžete založit nový incident na stránce Google Code za účelem podpory dalšího vývoje.';
...
$lang['about_app_license'] = 'Tooth Software je licencováno pod licencí GPLv3. Používáním kódu Tooth Software v jakékoli formě souhlasíte s podmínkami popsanými v dokumentu na následující adrese:';
...
$lang['ea_update_success'] = 'Aplikace Tooth Software byla úspěšně aktualizována.';
