...
$lang['about_app'] = 'Info su Tooth Software';
...
$lang['about_app_info'] = 'Tooth Software è un\'applicazione web estremamente personalizzabile che permette ai tuoi clienti di prenotare appuntamenti con te attraverso il web. Inoltre, fornisce la possibilità di sincronizzare i tuoi dati con Google Calendar in modo da poterli usare in altri servizi.';
$lang['current_version'] = 'Versione corrente';
$lang['support'] = 'Supporto';
$lang['about_app_support'] = 'Se incontri un problema quando utilizzi Tooth Software puoi cercare sul Gruppo Google ufficiale per le risposte. Potresti anche aver bisogno di creare una nuova segnalazione sulla pagina Google Code al fine di aiutarci negli sviluppi futuri.';
...
$lang['about_app_license'] = 'Tooth Software è distributo sotto licenza GPLv3. Usando il codice di Tooth Software stai accettando i termini e le condizioni descritte al seguente URL:';
...
$lang['ea_update_success'] = 'Tooth Software è stato aggiornato con successo.';
...
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the Tooth Software API.';
