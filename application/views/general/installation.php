...
<head>
    ...
    <title>Installation | Tooth Software</title>
...
<header>
    <div class="container">
        <h1 class="page-title">Tooth Software Installation</h1>
    </div>
</header>

<div class="content container">
    <div class="welcome">
        <h3>Welcome to the Tooth Software installation page.</h3>
        <p>
            This page will help you set the main settings of your Tooth Software installation.
            ...
            url to connect to the backend section of Tooth Software.

            If you face any problems during the usage of Tooth Software you can always check the
            <a href="http://toothsoftware.org/docs.html">Documentation</a>
            ...
            <a href="https://github.com/alextselegidis/toothsoftware/issues">GitHub Issues</a>
    ...
    <p>
    <h3>License</h3>
    Tooth Software is licensed under the <span class="badge badge-default">GPL-3.0 license</span>.
    By using the code of Tooth Software in any way <br> you agree with the terms described in the
    following url:
    ...
    <button type="button" id="install" class="btn btn-success btn-large">
        ...
        Install Tooth Software
    </button>
</div>

<footer>
    Powered by <a href="https://toothsoftware.com">Tooth Software</a>
</footer>
