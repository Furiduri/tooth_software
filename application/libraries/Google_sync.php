 ...
 * Class Google_sync
 *
 * This class implements all the core synchronization between the Google Calendar and the Tooth Software system.
 *
...
class Google_sync {
     ...
     * where the user grants access to his data for the Tooth Software app.
     */
     ...
     * when the provider granted consent to Tooth Software for use his
     ...
     *
     * This method checks whether the appointment's provider has enabled the Google Sync utility of Tooth Software
     ...
     * provided appointment record of Tooth Software.
     *
     * @param array $appointment Contains the appointment record data.
     * @param array $provider Contains the provider record data.
     * @param array $service Contains the service record data.
