 ...
 * Class Console
 *
 * CLI commands of Tooth Software, can only be executed from a terminal and not with a direct request.
 */
class Console extends EA_Controller {
     ...
     *
     * Use this method to install Tooth Software directly from the terminal.
     *
     * Usage:
     *
     ...
     *
     * Use this method to backup your Tooth Software data.
     *
     * Usage:
     *
    ...
    public function backup()
    {
        ...
        $filename = 'toothsoftware-backup-' . date('Y-m-d-His') . '.gz';
     ...
     *
     * Use this method in a cronjob to automatically sync events between Tooth Software and Google Calendar.
     *
     * Notice:
     *
